	 ...
	 <?php 
      ...
      ?>
		...
		<div id="post-<?php the_ID(); ?>" <?php post_class('style'); ?>>
		 ...
		 <p class="postmetadata"><?php _e('Posted by','Mimbo'); ?> <?php the_author_posts_link('namefl'); ?>  <?php if ( in_category('6') ) { ?><?php } else { ?><?php _e('on','Mimbo'); ?> <?php the_time('n/d/y'); ?><?php } ?> &bull; <?php _e('Categorized as','Mimbo'); ?> <?php the_category(',') ?></p>
